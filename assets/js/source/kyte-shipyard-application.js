...
let colDefApps = [
    ...
    {'targets':2,'data':'aws_key.username','label':'AWS Username'}, // todo, check if null and return empty
    {'targets':3,'data':'aws_key.public_key','label':'AWS Public Key'}, // todo, check if null and return empty
];
